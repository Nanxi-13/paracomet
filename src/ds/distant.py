...
#     comet_model = None
    if args.comet:
        ...
        ## Nanxi
        #[models.put(AtomicModel(comet_location, vocabulary_path="../../data/"))for i in range(0,dev_count)]
        [models.append(AtomicModel(comet_location, vocabulary_path="../../data/"))for i in range(dev_count)]
